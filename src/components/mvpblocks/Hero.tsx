        ...
        <div className="z-10 mx-auto max-w-7xl gap-12 px-4 py-28 text-gray-600 md:px-8">
          <div className="mx-auto max-w-3xl space-y-5 text-center leading-0 lg:leading-5">
            ...
            <p className="mx-auto max-w-2xl text-gray-300">
              The all-in-one platform for IRL creators. Stream to multiple platforms, engage with your community, and monetize your content—all without complex setup or expensive equipment.
            </p>
