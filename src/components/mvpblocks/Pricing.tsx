...
const plans = [
  {
    ...
    description:
      'Perfect for creators just starting their IRL streaming journey.',
    features: [
  ...
  },
  {
    ...
    description: 'For growing creators who want professional features and reach.',
    features: [
      'Stream to 4 platforms simultaneously',
      '1080p streaming quality',
      'Advanced chat & moderation',
      'Tipping & donations',
      'Premium overlays & scenes',
      'Priority support',
    ],
  ...
  },
  {
    ...
    description: 'For professional creators and agencies building serious audiences.',
    features: [
